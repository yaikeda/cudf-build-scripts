...
## CUDA Toolkit
BUILD_CUDA_MAJOR_VERSION=12
BUILD_CUDA_MINOR_VERSION=9
wget https://developer.download.nvidia.com/compute/cuda/repos/wsl-ubuntu/x86_64/cuda-wsl-ubuntu.pin
sudo mv cuda-wsl-ubuntu.pin /etc/apt/preferences.d/cuda-repository-pin-600
wget https://developer.download.nvidia.com/compute/cuda/${BUILD_CUDA_MAJOR_VERSION}.${BUILD_CUDA_MINOR_VERSION}.0/local_installers/cuda-repo-wsl-ubuntu-${BUILD_CUDA_MAJOR_VERSION}-${BUILD_CUDA_MINOR_VERSION}-local_${BUILD_CUDA_MAJOR_VERSION}.${BUILD_CUDA_MINOR_VERSION}.0-1_amd64.deb
sudo dpkg -i cuda-repo-wsl-ubuntu-${BUILD_CUDA_MAJOR_VERSION}-${BUILD_CUDA_MINOR_VERSION}-local_${BUILD_CUDA_MAJOR_VERSION}.${BUILD_CUDA_MINOR_VERSION}.0-1_amd64.deb
sudo cp /var/cuda-repo-wsl-ubuntu-${BUILD_CUDA_MAJOR_VERSION}-${BUILD_CUDA_MINOR_VERSION}-local/cuda-*-keyring.gpg /usr/share/keyrings/
sudo apt-get update
sudo apt-get -y install cuda-toolkit-${BUILD_CUDA_MAJOR_VERSION}-${BUILD_CUDA_MINOR_VERSION}
